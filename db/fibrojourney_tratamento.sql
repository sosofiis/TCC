...
CREATE TABLE `tratamento` (
  ...
  `tratamento` enum('medicamento para dor','terapia','tratamento multidisciplinar','não fiz tratamento') DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `tratamento_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `fj_users` (`id`)
